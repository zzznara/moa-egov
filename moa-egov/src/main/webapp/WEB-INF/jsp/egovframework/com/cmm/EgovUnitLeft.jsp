...
<table>
	<tr>
		<td><strong>모아모아</strong></td>
	</tr>
	<tr>
		<td><a href="<c:url value="/moa/bible/bibleList.do"/>" target="_content" class="link">성경보기</a></td>
	</tr>
	<tr>
		<td><a href="<c:url value="/moa/bible/bibleTodayList.do"/>" target="_content" class="link">오늘의 말씀</a></td>
	</tr>
	<tr>
		<td><a href="<c:url value="/moa/bible/bibleByTranslate.do"/>" target="_content" class="link">성경DB 생성</a></td>
	</tr>
	<tr>
		<td><a href="<c:url value="/moa/bible/bibleDropdown.do"/>" target="_content" class="link">성경목록 dropdown</a></td>
	</tr>
</table>
