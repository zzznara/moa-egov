...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;배치스케줄 등록</h1></td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="배치스케줄등록을 위한 테이블.">
  ...
  <!--
  <tr>
    <th width="15%" height="23" class="required_text" scope="row" nowrap ><label for="batchSchdulId">배치스케줄ID</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="85%" nowrap>
   ...
   -->
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="batchOpertId">배치작업ID</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td nowrap>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="batchOpertNm">배치작업명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="executCycle">실행주기</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
