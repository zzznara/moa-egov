...
<script type="text/javascript" src="<c:url value='/js/egovframework/moa/plugin/moa-search/moa-search-fn.js'/>${dto.addVersion}"></script>
...
<script type="text/javascript" src="<c:url value='/js/egovframework/moa/bible/bibleList.js' />${dto.addVersion}"></script>
